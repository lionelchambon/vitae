...
\begin{itemize}[noitemsep, topsep=0pt, left=0.65cm]
    ...
    \item Follow the links for sample \href{https://lionelchambon.github.io/coursework/}{coursework} and \href{https://github.com/lionelchambon}{codes.} \\
\end{itemize} 
...
\begin{itemize}[noitemsep, topsep=0pt, left=0.65cm]
    ...
    \item Added principal components from consumer surveys to test whether distributional dynamics are observable in the data.
...
\textit{Director, International and Euro Area Economy Division at Deutsche Bundesbank} \\
\href{mailto:johannes.hoffmann@bundesbank.de}{johanes.hoffmann@bundesbank.de} \\
